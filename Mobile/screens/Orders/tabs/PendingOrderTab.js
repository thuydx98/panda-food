...
export default class PendingOrderTab extends React.Component {
                ...
                {this.props.orders?.map(order => {
                    return (
                        ...
                        >
                            ...
                            <View style={{ flexDirection: 'row', width: '100%', paddingTop: 10, borderTopColor: '#d4d4d4', borderTopWidth: .5, justifyContent: 'flex-end' }}>
                                <Button
                                    containerStyle={{ width: '35%' }}
                                    buttonStyle={styles.buttonReorder}
                                    title='Cancel'
                                    onPress={() => this.props.onCancelOrder(order.id)}
                                />
                            </View>
                        </TouchableOpacity>
                    )
