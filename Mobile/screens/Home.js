...
class Home extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    if (!stateGetProducts.products || stateGetProducts.products.length === 0) {
      ...
      if (
        !response ||
        !this.props.stateGetProducts.isSuccess ||
        !this.props.stateGetProducts.products
      ) {
        this.setState({
  ...
  render() {
    ...
    const products = this.props.stateGetProducts.products
      ? this.props.stateGetProducts.products
      : [];
