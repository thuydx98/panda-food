...
export class WarehouseService {
  ...
  // private readonly testExport = 'http://localhost:50007/api/warehouse/';
  ...
  public getExportHistories(storeId: number): Observable<ImportExportHistoryViewModel[]> {
    return this.http.get(this.materialWarehouseApiUrl + 'export-histories' + '?storeId=' + storeId)
    .pipe(
