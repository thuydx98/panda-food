...
using WarehouseApi.Business.Warehouse.Queries.GetExportHistories;
...
namespace WarehouseApi.Warehouse
{
    ...
    public class WarehouseController : ControllerBase
    {
        ...
        private readonly IGetExportHistoriesQuery _getExportHistoriesQuery;
        ...
        public WarehouseController(
            ...
            IGetExportHistoriesQuery getExportHistoriesQuery)
        {
            ...
            _getExportHistoriesQuery = getExportHistoriesQuery;
        }
        ...
        public async Task<IActionResult> GetExportHistoriesAsync(int? storeId)
        {
            var result = await _getExportHistoriesQuery.ExecuteAsync(storeId);
            return new ObjectResult(result);
        }
